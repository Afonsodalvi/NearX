...
contract FuncoesModifier {
    ...
    uint256 public x = 10; //o valor armazenado na variavel para usarmos no decrement e evitar o ataque de rentrada
    ...
    // o contrato.
    modifier onlyOwner() {
        //na prática vamos ver muito o uso desse modifier
    ...
    function decrement(uint256 i) public noReentrancy {
        ...
        if (i > 1) {
            //se o valor de é maior que 1 continua e executa novamente a mesma função
